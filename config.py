...
cfg['max_epoch'] = 200
cfg['seed'] = 1
cfg['valid_epoch'] = 5  # Epoch term of validation
cfg['ngpu'] = 1

# Log config
cfg['log_step'] = 100  # Step term of log
cfg['exp_root'] = '/home/sr2/Hyeokjun/OOD-saige/results/'
cfg['exp_dir'] = 'wrn28-10_cifar10_godin_hc_gi'
cfg['ckpt_epoch'] = 20  # Epoch term of saving checkpoint file.

# Load Checkpoint
cfg['load_ckpt'] = '/home/sr2/Hyeokjun/OOD-saige/results/wrn28-10_cifar10_godin_hc_gi/ckpt/checkpoint_epoch_100.pyth' # ckpt file(.pyth) "absolute path"
...
cfg['in_dataset']['dataset'] = 'imagenet_resize'
